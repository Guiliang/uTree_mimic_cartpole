...
class DeepQ:
    ...
    def save_cartpole_model(self, name):
        save_model(self.model, name)
        save_model(self.targetModel, 'target-' + name)
...
def train_cartpole():
    ...
    for epoch in xrange(epochs):
        ...
        for t in xrange(steps):
            ...
            observation_list.append(observation.tolist()+[action])
        ...
        save_csv_all_observations(observation_list, './record_training_observations.csv')

        explorationRate *= 0.995
        # explorationRate -= (2.0/epochs)
        explorationRate = max(0.05, explorationRate)

        deepQ.save_cartpole_model('cartpole-v0-save-r3.h5')
...
def test_cartpole():
    ...
    # deepQ.targetModel = load_model('cartpole-v0-save.h5')
    deepQ.model = load_model('cartpole-v0-save-r2.h5')
    ...
    for epoch in xrange(epochs):
        ...
        # save_csv_all_correlations(record_transition,
        #                           './save_all_transition_append/record_cartpole_transition_game{0}.csv'.format(int(epoch)))
...
def save_csv_all_observations(record_observation, csv_name):
